...
(let ((c '((class color) (min-colors 89)))
  ...
  (let* ((bg             "#262c34")
    ...
    (custom-theme-set-faces
     ...
     `(header-line            ((,c (:inherit doom-default))))
     ...
     `(linum-relative-current-face ((,c (:foreground ,bg-d :foreground ,blue :bold t))))
     ...
     ;; Powerline/Spaceline
     `(spaceline-highlight-face    ((,c (:foreground ,black :background ,blue))))
     ...
     `(helm-header                 ((,c (:foreground ,white :background ,white :underline t :box t))))
     `(helm-header-line-left-margin ((,c (:foreground ,blue :background ,nil))))
     `(helm-buffer-process                 ((,c (:foreground ,white :background ,white))))
     `(helm-swoop-target-line-face ((,c (:foreground ,highlight :inverse-video t))))
     `(helm-ff-file                ((,c (:foreground ,fg :background ,bg))))
     ...
     ;; Anzu-mode
     `(anzu-mode-line ((,c (:foreground ,blue :inherit bold))))
     ;; Rainbow delimiters
     ...
     ;; term
     `(term ((,c (:foreground ,white :background ,bg))))
     `(term-color-black ((,c (:foreground ,bg-d))))
     `(term-color-blue ((,c (:foreground ,blue))))
     `(term-color-cyan ((,c (:foreground ,cyan))))
     `(term-color-green ((,c (:foreground ,green))))
     `(term-color-magenta ((,c (:foreground ,magenta))))
     `(term-color-red ((,c (:foreground ,red))))
     `(term-color-white ((,c (:foreground ,white))))
     `(term-color-yellow ((,c (:foreground ,yellow))))
